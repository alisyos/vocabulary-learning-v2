...
요구사항:
1. 정의: 각 용어 설명은 교과개정 상의 설명으로 기입. 명사형으로 작성. 핵심 개념어가 설명에 포함되지 않도록 구성하십시오.
2. 예문: 반드시 용어를 포함해야 하며, 학년 수준에 맞는 어휘와 문장들로 구성하고 '-다'로 문장이 마무리되도록 구성하십시오.
